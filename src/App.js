...
const App = () => {
	...
	const [{minimum, maximum}, setWeight] = useState({minimum: 0, maximum: 300,})
	...
	function handleChangeWeightMaximum(event) {
		setWeight({maximum: parseFloat(event.target.value)})
		handleGetBreedCount()
	}
...
// Todo Figure out how to display data from api!
	...
	return (<div className="App">
			...
			<div>
				...
				<div>
					<div>
						...
						<input type="number" pattern="[0-9]*" name="weightMinimum" onChange={handleChangeWeightMinimum}/>
					</div>
					<div>
						<label>Maximum Weight: </label>
						<input type="number" pattern="[0-9]*" onChange={handleChangeWeightMaximum}/>
					</div>
				</div>
				<div>
				...
				<div>
					{breeds &&
					<ShowAllBreedsButton
						onClick={() => setBreedInfo({showAllBreeds: !showAllBreeds})}
			...
			<div>
				...
				<div>
					<BackToResultsButton
						onClick={() => setBreedInfo({singleBreedInfo: null, showSingleBreedInfo: false})}
						className="btn"
					/>
				</div>
				<div>
					<p><strong>Energy Level: </strong><Stars solidStars={singleBreedInfo["energy_level"]}/></p>
					<p><strong>Playfulness: </strong><Stars solidStars={singleBreedInfo["playfulness"]}/></p>
					<p><strong>Friendliness to Dogs: </strong><Stars
						solidStars={singleBreedInfo["friendliness_to_dogs"]}/></p>
					<p><strong>Friendliness to Other Pets: </strong><Stars
						solidStars={singleBreedInfo["friendliness_to_other_pets"]}/></p>
					<p><strong>Friendliness to New People: </strong><Stars
						solidStars={singleBreedInfo["friendliness_to_strangers"]}/></p>
					<p><strong>Ease of Training: </strong><Stars solidStars={singleBreedInfo["ease_of_training"]}/></p>
					<p><strong>Grooming Needs: </strong><Stars solidStars={singleBreedInfo["grooming_requirements"]}/>
					</p>
					<p><strong>Exercise Needs: </strong><Stars solidStars={singleBreedInfo["exercise_requirements"]}/>
					</p>
					<p><strong>Affection Level: </strong><Stars solidStars={singleBreedInfo["affection_level"]}/></p>
					<p><strong>Watchfulness: </strong><Stars solidStars={singleBreedInfo["watchfulness"]}/></p>
					<p><strong>Heat Sensitivity: </strong><Stars solidStars={singleBreedInfo["heat_sensitivity"]}/></p>
					<p><strong>Vocality: </strong><Stars solidStars={singleBreedInfo["vocality"]}/></p>
				...
				<div>
					...
					<p>
						...
						{!(singleBreedInfo["personality"].length <= 300) && <button className="read-more-btn"
						                                                            onClick={() => this.setState({showFullPersonality: !showFullPersonality})}>
